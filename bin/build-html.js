...
for (const nextItem of await (
  await fetch("https://kherrick.github.io/soylent-news/index.json")
).json()) {
...
archivesHeaderLink.setAttribute(
  "href",
  "https://github.com/kherrick/soylent-news/blob/main/archives/index.md"
);
...
(
  await (
    await fetch(
      "https://raw.githubusercontent.com/kherrick/soylent-news/main/archives/index.md"
    )
  ).text()
)
  .split("\n")
  ...
  .forEach((line) => {
    ...
    archiveYearLink.setAttribute(
      "href",
      "https://github.com/kherrick/soylent-news/blob/main/archives/" + indexPath
    );
